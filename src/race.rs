...
fn determine_size(race: String, full_race_data: &serde_json::Map<String, serde_json::Value>) {
...
impl Race {
    pub fn new(name: String, full_race_data: &Map<String, Value>) -> Race {
        Race {
            name: name,
            age: 20,
            size: determine_size(name, full_race_data),
            speed: 30,
